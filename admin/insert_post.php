                ...
                <div class="add_admin_content">
                   <h2>Insert New Course</h2>
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" method="post">
                        ...
                        <p>
                            <label for="post_featured_image">Course PDF</label>
                            <input type="file" value="Course PDF" name="post_pdf">
                        </p>
                        <p>
...
$post_pdf = $_FILES['post_pdf']['name'];
$post_pdf_tmp = $_FILES['post_pdf']['tmp_name'];
...
$post_date = date('d-m-y');  
    ...
    move_uploaded_file($post_featured_image_tmp,"uploads/$post_featured_image");
    move_uploaded_file($post_pdf_tmp,"uploads/$post_pdf");
    $insert_post = "insert into posts (cat_id,post_title,post_date,post_author,post_keywords	,post_image,post_content,video_link,pdf) values ('$post_categories','$post_title','$post_date','$post_author','$post_keywords','$post_featured_image','$post_content','$course_video','$post_pdf')";
